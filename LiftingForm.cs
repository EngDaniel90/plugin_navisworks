...
namespace AutoLiftingClashAnalysis
{
    public partial class LiftingForm : Form
    {
        ...
        private async Task<bool> RunSimulation(Document doc, ModelItemCollection items, ClashTest test, double heightMeters, double stepMeters)
        {
            ...
            // OPTIMIZATION: Convert to COM selection ONCE before the loop to avoid repeated marshalling overhead.
            // This is critical for performance as ComApiBridge.ToInwOpSelection is expensive.
        ...
        private void MoveItemsUsingCOM(ComApi.InwOpSelection comSelection, double zMeters)
        {
            try
            {
                ...
                // 2. Usar Seleção COM Pré-Calculada (Evita Marshalling Repetido)
