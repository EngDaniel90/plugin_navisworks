...
namespace AutoLiftingClashAnalysis
{
    public partial class LiftingForm : Form
    {
        ...
        private async Task<bool> RunSimulation(Document doc, ModelItemCollection items, ClashTest test, double heightMeters, double stepMeters)
        {
            ...
            // ⚡ Bolt Optimization: Cache COM State and Selection outside the loop
            // This prevents O(N) marshalling overhead inside the fast-running simulation loop.
            ...
            try
            {
                ...
                while (currentZMeters >= 0)
                {
                    ...
                    // ⚡ Bolt Optimization: Early exit from simulation loop to avoid redundant TestsRunTest
